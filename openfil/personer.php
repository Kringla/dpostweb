                ...
                <table id="table-personer" class="data-table" data-list-table data-rows-per-page="25" data-empty-message="Ingen treff.">
                  <thead>
                    ...
                    <tr class="filter-row">
                      ...
                      <th><input type="search" class="column-filter" data-filter-column="1" data-filter-mode="contains" placeholder="S&oslash;k rolle" aria-label="S&oslash;k i roller" /></th>
                      <th></th>
                      <th></th>
                    </tr>
                  </thead>
            ...
            <div class="secondary-card">
              ...
              <?php if ($selectedPersonData !== null): ?>
                <?php
                  ...
                  if ($selectedPersonData['birth_info'] !== '') {
                      $summaryItems[] = ['label' => 'F&oslash;dt', 'value' => $selectedPersonData['birth_info']];
                  }
                  if ($selectedPersonData['nation'] !== '') {
                      $summaryItems[] = ['label' => 'Nasjon', 'value' => $selectedPersonData['nation']];
                  }
                  if ($selectedPersonData['related_orgs'] !== '') {
                      $summaryItems[] = ['label' => 'Relaterte fart&oslash;y/bedrifter', 'value' => $selectedPersonData['related_orgs']];
                  }
                  if ($selectedPersonData['related_places'] !== '') {
                      $summaryItems[] = ['label' => 'Relaterte steder', 'value' => $selectedPersonData['related_places']];
                  }
                  $summaryItems[] = ['label' => 'Antall artikler', 'value' => (string)$selectedPersonData['article_count']];
                  $summaryItems[] = ['label' => 'Antall bilder', 'value' => (string)$selectedPersonData['image_count']];

                  if ($selectedPersonData['external_link'] !== '' && filter_var($selectedPersonData['external_link'], FILTER_VALIDATE_URL)) {
                      $summaryItems[] = [
                          'label' => 'Lenke',
                          'value' => '<a href="' . h($selectedPersonData['external_link']) . '" target="_blank" rel="noopener">Ekstern kilde</a>'
                      ];
                  }
                ?>
