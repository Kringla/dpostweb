            ...
            <div class="table-wrap" data-table-wrap>
              ...
              <div class="table-scroll">
                <table id="table-verft" class="data-table" data-list-table data-rows-per-page="25" data-empty-message="Ingen treff.">
                  <thead>
                    <tr>
                      <th class="name-col">Verft</th><th>Sted</th><th class="count-col">Fartøyer</th>
                    </tr>
                    <tr class="filter-row">
                      <th><input type="search" class="column-filter" data-filter-column="0" data-filter-mode="contains" placeholder="Søk verft" aria-label="Søk i verft" /></th>
                      <th><input type="search" class="column-filter" data-filter-column="1" data-filter-mode="contains" placeholder="Søk sted" aria-label="Søk i steder" /></th>
                      <th></th>
                    </tr>
                  </thead>
                  <tbody>
          ...
          <section class="dual-table-panel dual-table-panel--secondary">
            <div class="secondary-card">
              <h2 class="secondary-title">
                Fartøyer<?php if ($selectedYard !== null) { echo ' fra ' . h($selectedYard['name']); } ?>
              </h2>
                ...
                <div class="table-wrap table-wrap--static">
                  <div class="table-scroll">
                    <table class="data-table data-table--compact">
                      <thead>
                        <tr>
                          <th class="title-col">Fartøy</th><th>Type</th><th>Periode</th><th>Byggenr</th>
                        </tr>
                      </thead>
                      <tbody>
                      ...
                      <?php elseif (empty($yardVessels)): ?>
                        <tr data-empty-row="true"><td colspan="4">Ingen fartøy registrert for dette verftet.</td></tr>
                      <?php else: ?>
