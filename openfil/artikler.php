      ...
      <div class="card-content">
        ...
        <div class="table-wrap" data-table-wrap>
          ...
          <div class="table-scroll">
            <table id="table-artikler" class="data-table" data-list-table data-rows-per-page="25" data-empty-message="Ingen treff.">
              <thead>
                <tr>
                ...
                <tr class="filter-row">
                  ...
                  <th><input type="search" class="column-filter" data-filter-column="1" data-filter-mode="contains" placeholder="Søk forfatter" aria-label="Søk i forfattere" /></th>
